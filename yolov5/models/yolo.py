...
import timm
from .mobilenetv4 import MobileNetV4ConvSmall, MobileNetV4ConvMedium, MobileNetV4ConvLarge
...
def parse_model(d, ch):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        # TODO: channel, gw, gd
            ...
            t = m
            m = timm.create_model(m, pretrained = args[0] if len(args) > 0 else True, features_only=True)
            c2 = m.feature_info.channels()
            print("Backbone features:", m.feature_info)  # see how many strides & channels you get
